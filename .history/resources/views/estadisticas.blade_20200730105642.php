            ...
            <div class="content">
                ...
                <div class="row">
                 ...
                 <div class="row">
                    ...
                    <ul>
                    @foreach ($visitasporinmueble as $inmueble)
                        @if ($inmueble->estado == 1)
                            <li>{{ $visitaporinmueble->calle }} - {{ $visitaporinmueble->nombre }}: Pendiente</li>
                        @if ($inmueble->archivo == 2)
                            <li>{{ $visitaporinmueble->calle }} - {{ $visitaporinmueble->nombre }}: Seguimiento</li>
                        @if ($inmueble->archivo == 3)
                            <li>{{ $visitaporinmueble->calle }} - {{ $visitaporinmueble->nombre }}: Visitando</li>
                        @if ($inmueble->archivo == 4)
                            <li>{{ $visitaporinmueble->calle }} - {{ $visitaporinmueble->nombre }}: Oferta</li>
