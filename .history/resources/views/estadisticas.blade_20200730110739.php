                 ...
                 <div class="row">
                    ...
                    @foreach ($visitasestado as $inmueble)
                        @if ($inmueble->estado == '1')
                            <li>{{ $inmueble->calle }} - {{ $inmueble->nombre }}: 'Pendiente'</li>
                        @if ($inmueble->archivo == '2')
                            <li>{{ $inmueble->calle }} - {{ $inmueble->nombre }}: Seguimiento</li>
                        @if ($inmueble->archivo == '3')
                            <li>{{ $inmueble->calle }} - {{ $inmueble->nombre }}: Visitando</li>
                        @if ($inmueble->archivo == '4')
                            <li>{{ $inmueble->calle }} - {{ $inmueble->nombre }}: Oferta</li>
